...
use Com\Youzan\Cloud\Extension\Param\StockAllotInOrderResultDTO;
 ...
 */
class StockAllotInOrderResultDTOOutParam implements \JsonSerializable {
    ...
    /**
     *
     * @var StockAllotInOrderResultDTO
     */
    private $data;
